...
/* ===== NEXUSSHOP FULL UI REDESIGN ===== */
:root{
  --bg:#f5f7fb;--bg-card:#fff;--primary:#111827;--primary-light:#1f2937;
  --accent:#635bff;--accent-light:#eceaff;--accent-dark:#5148e8;
  --muted:#667085;--muted-light:#98a2b3;--surface:#f1f3f7;
  --success:#12b76a;--warning:#fdb022;--radius:20px;--radius-sm:12px;
  --shadow:0 10px 35px rgba(16,24,40,.07);--shadow-hover:0 20px 55px rgba(16,24,40,.12);
  --transition:.22s ease;--container:1280px
}
body{background:var(--bg);color:var(--primary);font-family:Inter,system-ui,sans-serif}
header{background:rgba(255,255,255,.86);backdrop-filter:blur(20px);border-bottom:1px solid #eaecf0}
.header-inner{min-height:76px;padding:14px 0}
.brand{font-size:23px;letter-spacing:-.8px}
.brand i,.brand .accent{color:var(--accent)}
.main-nav ul{gap:6px}
nav.main-nav li a{border-radius:12px;padding:10px 15px;color:#667085}
nav.main-nav li a:hover,nav.main-nav li a.active{background:#f1f0ff;color:var(--accent)}
.search-wrap{background:#f7f8fa;border:1px solid #eaecf0;min-width:250px;border-radius:13px}
.search-wrap:focus-within{border-color:#b8b2ff;background:#fff;box-shadow:0 0 0 4px rgba(99,91,255,.10)}
.header-actions .icon-btn{border-radius:12px;width:42px;height:42px}
.header-actions .icon-btn:hover{background:#f1f0ff;color:var(--accent)}
.cart-count{background:#ff4d67;border:2px solid #fff}

.hero{
  margin:24px 24px 0;min-height:520px;border-radius:30px;
  background:#15162b url('https://images.unsplash.com/photo-1555529669-e69e7aa0ba9a?auto=format&fit=crop&w=1800&q=85') center/cover
}
.hero:after{content:'';position:absolute;inset:0;background:linear-gradient(90deg,rgba(12,13,30,.95),rgba(12,13,30,.70) 45%,rgba(12,13,30,.10));}
.hero:before{opacity:.18}
.hero .container{z-index:2}
.hero .badge{background:rgba(255,255,255,.11);border:1px solid rgba(255,255,255,.16);color:#fff;padding:7px 14px}
.hero h1{font-family:Inter,sans-serif;font-size:60px;letter-spacing:-2.5px;line-height:1.02}
.hero p{font-size:17px;color:rgba(255,255,255,.72)}
.btn{height:48px;border-radius:13px;padding:0 22px}
.btn-primary{background:var(--accent);border-color:var(--accent);box-shadow:0 12px 28px rgba(99,91,255,.28)}
.btn-primary:hover{background:var(--accent-dark);border-color:var(--accent-dark)}
.btn-ghost{background:#fff;color:#111827;border-color:#fff}
.btn-ghost:hover{background:#f4f4f6;color:#111827}

.section{padding:64px 0}
.section-header{margin-bottom:28px}
.section-header .title-group h2{font-size:30px;letter-spacing:-.8px}
...
.cat-card{border:1px solid #eaecf0;border-radius:20px;box-shadow:none;padding:25px 15px}
.cat-card:hover{transform:translateY(-5px);box-shadow:var(--shadow-hover);border-color:#d9d5ff}
.cat-card .icon-wrap{width:58px;height:58px;border-radius:17px;background:#f0efff;color:var(--accent)}
.cat-card:hover .icon-wrap{background:var(--accent);color:#fff}
.cat-card h4{font-size:14px}.cat-card .count{font-size:12px}

.products-grid{grid-template-columns:repeat(4,1fr);gap:18px}
.product-card{border:1px solid #eaecf0;border-radius:21px;box-shadow:none}
.product-card:hover{transform:translateY(-6px);box-shadow:var(--shadow-hover);border-color:#dedbff}
.product-card .img-wrap{background:#f4f5f8}
.product-card .badge{background:#111827;border-radius:8px;padding:5px 10px}
.product-card .badge.sale{background:#ffe7ec;color:#d92d54}
.product-card .wish-btn{border-radius:12px;box-shadow:0 4px 15px rgba(16,24,40,.08)}
.product-card .body{padding:17px 18px 12px}
.product-card .body .category-tag{color:#98a2b3}
.product-card .body h5{font-size:16px}
.product-card .body .price{font-size:19px}
.product-card .footer{padding:0 18px 18px}
.product-card .footer .add-btn{height:42px;border-radius:12px;background:#f1f2f7;color:#111827}
.product-card .footer .add-btn:hover,.product-card .footer .add-btn.added{background:var(--accent)}

.deal-wrap{border-radius:26px;box-shadow:none;border:1px solid #eaecf0}
.deal-wrap .deal-img{flex-basis:50%}
.deal-wrap .deal-content{padding:52px}
.deal-wrap .deal-content .tag{background:#fff1c2;color:#8b5e00}
.deal-wrap .deal-content h3{font-size:34px;letter-spacing:-1px}
.deal-wrap .deal-content .price-big{font-size:36px}
.timer-box{background:#15162b;border-radius:13px;border:1px solid #2d3047}

.testimonial-card{border:1px solid #eaecf0;box-shadow:none;border-radius:20px}
.testimonial-card:hover{box-shadow:var(--shadow-hover)}
.testimonial-card blockquote{font-style:normal}
.testimonials-scroll::-webkit-scrollbar-thumb{background:#c9c5ff}

.newsletter-wrap{background:linear-gradient(135deg,#17182d,#292b4d);border-radius:26px;padding:48px 52px}
.newsletter-wrap form input{border:1px solid rgba(255,255,255,.10)}
.newsletter-wrap form .btn{background:var(--accent);border-color:var(--accent)}

footer{background:#11121f;color:#fff;border-top:0;padding:52px 0 26px}
.footer-grid .brand-col p,.footer-grid .col ul li a{color:#9296aa}
.footer-grid .col h5{color:#fff}.footer-grid .brand-col .socials a{background:#222437;color:#aeb2c5}
.footer-grid .brand-col .socials a:hover{background:var(--accent);color:#fff}
.footer-bottom{border-top:1px solid #292b3b;color:#73778d}
...
@media(max-width:992px){
 .hero{margin:16px 16px 0;min-height:440px}
 .hero h1{font-size:46px}
}
@media(max-width:768px){
 .header-inner{min-height:66px}
 .search-wrap{min-width:0;flex:1}
 .hero{margin:10px 10px 0;border-radius:22px;min-height:430px}
 ...
 .deal-wrap{flex-direction:column}.deal-wrap .deal-img{flex-basis:230px}.deal-wrap .deal-content{padding:32px 26px}
 .newsletter-wrap{padding:32px 24px}
}
@media(max-width:480px){
 .container{padding:0 14px}.hero h1{font-size:30px}
 .products-grid,.categories-grid{gap:10px}
 .product-card .body{padding:13px 12px 8px}.product-card .body h5{font-size:13px}
 .product-card .footer{padding:0 12px 12px}
 .product-card .footer .add-btn{font-size:12px}
 .cat-card{padding:16px 8px}.cat-card .icon-wrap{width:46px;height:46px;font-size:19px}
}
